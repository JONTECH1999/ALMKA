...
<head>
  ...
  <style>
    ...
    .status { margin: 8px 0 16px; font-size: 0.95rem; }
    img { width: 100%; max-width: 720px; height: auto; display: block; margin: 0 auto; }
  </style>
</head>
<body>
  <header>
    <h1>ESP32-CAM Stream</h1>
    <div class="status">Video starts automatically when the page opens.</div>
  </header>
